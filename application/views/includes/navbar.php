<div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <button type="button" data-toggle="collapse" data-target=".navbar-collapse" class="navbar-toggle"><span class="fa fa-gear"></span></button><a href="#" class="navbar-brand"><span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KASALONGKHAM</span></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active" onclick="main_view()"><a href="#">Home</a></li>
                <li onclick="load_Sport('1');"><a href="#">ประเภท กีฬา</a></li>
                <li onclick="load_Sport('2');"><a href="#">อาจารย์/เจ้าหน้าที่</a></li>
                <!--<li onclick=""><a href="<?PHP echo base_url('sports/upload2');?>">..</a></li>-->
